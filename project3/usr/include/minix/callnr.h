...
#define PM_MQ_OPEN			(PM_BASE + 48)
#define PM_MQ_CLOSE			(PM_BASE + 49)
#define PM_MQ_SEND			(PM_BASE + 50)
#define PM_MQ_RECEIVE		(PM_BASE + 51)
#define PM_MQ_SETATTR		(PM_BASE + 52)
#define PM_MQ_GETATTR		(PM_BASE + 53)
#define PM_MQ_REQNOTIFY 	(PM_BASE + 54)
